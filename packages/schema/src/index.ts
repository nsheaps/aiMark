...
import benchmarkProgramV1Schema from "../schemas/benchmark-program.v1.json" with { type: "json" };
import benchmarkV1Schema from "../schemas/benchmark.v1.json" with { type: "json" };
...
export type { AimarkBenchmarkProgramV1 } from "./generated/benchmark-program.v1";
export type { AimarkBenchmarkV1 } from "./generated/benchmark.v1";
...
export const validateBenchmarkProgramV1 = ajv.compile(benchmarkProgramV1Schema);
export const validateBenchmarkV1 = ajv.compile(benchmarkV1Schema);

export const RUN_SCHEMA_VERSION = "aimark.run.v1";
export const SAMPLES_SCHEMA_VERSION = "aimark.samples.v1";
export const BENCHMARK_SCHEMA_VERSION = "aimark.benchmark.v1";
